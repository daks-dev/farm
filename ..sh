    ...
    case $ac in
        ...
        "s")
            ...
            until [[ $acc == "-" ]]; do
                ...
                case $acc in
                    "1")
                        echo -e "> supervisor:stop master.dev";
                        sudo supervisorctl stop master.dev;;
                    "2")
                        echo -e "> supervisor:start master.dev";
                        sudo supervisorctl start master.dev;;
                    "3")
                        echo -e "> supervisor:restart master.dev";
                        sudo supervisorctl reread;
                        sudo supervisorctl restart master.dev;;
                    "4")
